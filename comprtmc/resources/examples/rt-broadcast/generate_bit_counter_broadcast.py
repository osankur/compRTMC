...
# active_duration = [(1,2), (3,4), (0,1), (1,2)]
# period =          [(5,6), (20,22), (15,16), (30,31)]
# active_duration = [(1,1), (3,3), (1,1), (2,2)]
# period =          [(10,10), (15,15), (20,20), (25,25)]
...
# total_time = 100
def dump(n, m, active_duration, period,timed):
    ...
    if timed:
        ...
        print(F"""INVARSPEC (visible_carry{n})""")
    else:
        print(F"\terr := visible_carry{n};")
        for i in range(0,n+1):
...
def main():
    ...
    parser.add_argument("-i", "--index", type=int, help="index of the delays")
